    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(onPressed: () => be1.hash_haval128(tec6.text, _controller), child: const Text('HAVAL128')),
          TextButton(onPressed: () => be1.hash_haval160(tec6.text, _controller), child: const Text('HAVAL160')),
          TextButton(onPressed: () => be1.hash_haval192(tec6.text, _controller), child: const Text('HAVAL192')),
          TextButton(onPressed: () => be1.hash_haval224(tec6.text, _controller), child: const Text('HAVAL224')),
          TextButton(onPressed: () => be1.hash_haval256(tec6.text, _controller), child: const Text('HAVAL256')),
          TextButton(onPressed: () => Navigator.pop(ctx), child: const Text('Storno')),
        ],
      ),
    );
